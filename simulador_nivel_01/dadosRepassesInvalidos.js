const dadosRepassesInvalidos = [ { "orgao": "Polícia Civil", "data":
...
"valor": 5100.00, "status": "sucesso"}, {"orgao":"MEC","data":"01/01/2024","valor":500.00,"status"
...
:"sucesso"},{"orgao":"Ministério da Educação","data":"08/01/2024","valor":600.00,"status":"sucesso"},
{"orgao":"Ministério da Saúde","data":"10/01/2024","valor":900.00,"status":"sucesso"}
,{"orgao":"Ministério da Educação","data":"12/01/2024","valor":300.00,"status":"falha"
...
dadosRepassesInvalidos.forEach(repasse => {
...
const dadosInvalidosFiltrados = dadosRepassesInvalidos.filter(t => {
    if (t.status === "sucesso") {
        return true;
    }
    if (t.status === "falha" && t.motivo && t.motivo.trim() !== "") {
        return true;
    }
    return false;
});
...
module.exports = {
    dadosRepassesInvalidos,
    dadosInvalidosFiltrados
};
